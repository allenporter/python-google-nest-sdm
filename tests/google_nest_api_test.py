...
async def test_camera_live_stream(aiohttp_server) -> None:
  ...
  async with aiohttp.test_utils.TestClient(server) as client:
    ...
    assert datetime.datetime(2018, 1, 4, 18, 30, tzinfo=datetime.timezone.utc) == stream.expires_at
    ...
    assert datetime.datetime(2019, 1, 4, 18, 30, tzinfo=datetime.timezone.utc) == stream.expires_at
    ...
    assert datetime.datetime(2020, 1, 4, 18, 30, tzinfo=datetime.timezone.utc) == stream.expires_at
